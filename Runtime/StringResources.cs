...
{
	internal static string SuppliedTypeIsNotAReferenceType(
		Type type)
	{
	...
	internal static string SuppliedTypeIsNotAGivenType(
		Type type,
		Type givenType)
	{
		return string.Format(CultureInfo.InvariantCulture,
	...
	internal static string MethodCallInvalidForObjectCurrentState(
		Type type,
		string method)
	{
		return string.Format(CultureInfo.InvariantCulture,
