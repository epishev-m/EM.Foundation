...
public sealed class CodeGeneratorEntityLibrarySource :
	ICodeGenerator
{
	...
	#endregion
	#region CodeGeneratorEntityLibrarySource

	public CodeGeneratorEntityLibrarySource(IEnumerable<TypeInfo> typesInfo)
	{
